...
class WalkthroughController: UIPageViewController {
    ...
    weak var welcomeDelegate: WalkthroughControllerDelegate?
    var bgimages : NSMutableArray?
...
protocol WalkthroughControllerDelegate: class {
     ...
     */
    func welcomePageViewController(_ welcomeController: WalkthroughController,
